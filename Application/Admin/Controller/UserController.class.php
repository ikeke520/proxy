...
class UserController extends AdminController
{
	...
	public function addUser(){
		...
		if (IS_POST) {
			...
			$builder->title("新增合伙人");
			$builder->keyText("username","账户");
			$builder->keyText("nickname","昵称","不填就与账户名一致");
			$builder->keyText('mobile',"手机");
			$builder->keyText('password',"登陆密码");
			$builder->keyText('remark',"备注");
			$builder->buttonSubmit(U("addUser"),"保存");
			$builder->display();
		}
	}
