...
namespace Gamepay\Model;
use Think\Model;

class Html5wxpayModel extends Model{
  ...
  {
    $this->mchid = "1423081102"; // 微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
    $this->appid = 'wx1040c62d14e0868f'; //公众号APPID 通过微信支付商户资料审核后邮件发送
    $this->key = 'yujiweixingzh8888888888888888888';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
  }
