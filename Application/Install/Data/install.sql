...
CREATE TABLE IF NOT EXISTS `ocenter_adv` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='广告表' AUTO_INCREMENT=10000 ;
...
CREATE TABLE IF NOT EXISTS `ocenter_adv_pos` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='广告位置表' AUTO_INCREMENT=10001 ;
...
(2, 'admin', 1, 'VIP', '', 1, ',338,340,341,344,10000');
...
CREATE TABLE IF NOT EXISTS `ocenter_issue_content` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='专辑内容表' AUTO_INCREMENT=31 ;
...
CREATE TABLE IF NOT EXISTS `ocenter_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10063 ;
...
(158, '回收站役底删除', 102, 0, 'SEO/doClear', 1, '', '', 0, '', ''),
...
CREATE TABLE IF NOT EXISTS `ocenter_module` (
  ...
  UNIQUE KEY `name` (`name`),
  KEY `name_2` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模块管理表' AUTO_INCREMENT=6 ;
